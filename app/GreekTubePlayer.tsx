...
export default function GreekTubePlayer() {
  ...
  function togglePlayback(){
    const target=currentPlayer();if(!target||typeof target.getPlayerState!=="function")return;
...
function Brand({home}:{home:()=>void}){return <button className="brand brand-home" aria-label="Αρχική σελίδα" onClick={()=>{home();window.location.assign("/");}}><span className="brand-mark">▶</span><span>GreekTube <b>Subs</b></span><small className="brand-version">ver 5.25</small></button>;}
