...
class TimingRepository:
            ...
            with connection.cursor() as cursor:
                cursor.execute(
                    ...
                    RETURNING job.job_id::text,job.video_id,job.transcript_version,job.source_hash,
                              job.source_cues,job.attempt_count,job.max_attempts
                    """,
            ...
            with connection.cursor() as cursor:
                cursor.execute(
                    ...
                    INSERT INTO audio_timing_artifacts(
                      ...
                      prosody_map,validation_json,worker_version
                    ) VALUES(
                      %s::uuid,%s,%s,%s,%s,'whisperx_audio',%s,%s,%s,%s,%s,%s,%s,%s,%s,%s
                    )
    ...
    def fail(self, job: TimingJob, error: Exception, permanent: bool = False) -> None:
